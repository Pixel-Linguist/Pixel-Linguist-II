...
# Text Corpus 2 (26M curated semantic text pairs) + the same 26M LAION pairs.
# Text Corpus 2 is train()'s default ./data/multilingual-filtered2, so no
# --unsupervised_data_path override is passed here.
# Point BASE_MODEL at ./Qwen2.5-VL-ViT-Only instead to get the paper's
# "mid-training only" row.

RUN="midtrain"

BASE_MODEL="./checkpoints/pretrain"
